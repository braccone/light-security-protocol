...
void setup()
{
  ...
  Serial.println(sizeof(WiFi.macAddress()));
...
void loop()
{
  ...
  if (packetSize)
  {
    ...
    if(incomingPacket[0] == '1')
    {
      ...
      clientID = incomingPacket;
      clientID.remove(0,1);
      Serial.print("clientID: ");
      Serial.println(clientID);
      String msg = clientID + "," + WiFi.macAddress() + "," + N1;
    ...
    // Encrypt
    // String encrypted = encrypt(replyPacket, enc_iv);
    // sprintf(ciphertext, "%s", encrypted.c_str());
    // Serial.print("Ciphertext: ");
    // Serial.println(encrypted);
    
    // Udp.beginPacket(Udp.remoteIP(), Udp.remotePort());
    // Udp.write((char*) encrypted.c_str());
    // Udp.endPacket();
